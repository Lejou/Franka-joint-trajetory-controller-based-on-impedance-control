...
#include <franka_effort_controller/api.h>
...
namespace franka_mc_rbdyn_urdf
{
...
public:
  ...
  franka_mc_rbdyn_urdf::Limits limits;
  std::map<std::string, std::vector<franka_mc_rbdyn_urdf::Visual>> visual;
