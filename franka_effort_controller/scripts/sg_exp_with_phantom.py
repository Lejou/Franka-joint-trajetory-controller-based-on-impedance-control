...
def main():
	...
	# dr = data_record()
	phantom_pose_base = [
	  	0.5405571208065953, -0.03527050432119672, 0.05651925194719826, 0.7059465999317835, -0.7078563359812327, 0.020758635985176594, 0.012336334356894314
	  ]
	phantom_pose_base0 = [
	  	0.5468711448039237, 0.01948632489783174, 0.057833438787013025, 0.7074662850404999, -0.7064476216633107, 0.014613321588037685, 0.014474734659773695
	  ]
	phantom_pose_base1 = [
	  	0.5239530248609112, -0.03251832742169929, 0.06070629223507512, 0.7074662850404999, -0.7064476216633107, 0.014613321588037685, 0.014474734659773695
	  ]
	phantom_pose_base2 = [
	  	0.5394498404691305, -0.0763908034258586, 0.05720445511744626, 0.7074662850404999, -0.7064476216633107, 0.014613321588037685, 0.014474734659773695
	  ]
	phantom_pose_base3 = [
	  	0.5488460739254057, -0.03101119024419449, 0.06206391028685701, 0.7074662850404999, -0.7064476216633107, 0.014613321588037685, 0.014474734659773695
	]
	...
	lip_pressure_ = -20
	lip_pressure_ratio = 5


	try:
		input("Start the Exp! Turn off PC")
		print("Turn off the main pressure!")
		pneumatic.turn_off_main_pressure()
		print("Turn off the lip pressure!")
		pneumatic.turn_off_lip()

		input("============ Press `Enter` to move to the start point ...")
		target_waypoints = []
		phantom_pose_test = copy.deepcopy(phantom_pose_base)
		phantom_pose_test[2] = phantom_pose_test[2]+0.03
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		pneumatic.panda.set_line_velocity_scale(0.25)
		pneumatic.panda.go_to_muti_line_movement(target_waypoints,True)
		print("Turn on the lip pressure!")
		pneumatic.turn_on_lip_with_limit_pressure(0)
		print("Record data!")
		pneumatic.turn_on_recording()
		input("============ Press `Enter` to move to the start point ...")
		target_waypoints = []

		phantom_pose_test = copy.deepcopy(phantom_pose_base0)
		# phantom_pose_test[0] = phantom_pose_base[0]-0.005
		# phantom_pose_test[1] = phantom_pose_base[1]+0.05
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test[2] = phantom_pose_base[2]-0.01
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))

		# phantom_pose_test = copy.deepcopy(phantom_pose_base)
		# phantom_pose_test[0] = phantom_pose_base[0]+0.015
		# phantom_pose_test[1] = phantom_pose_base[1]+0.03
		# phantom_pose_test[2] = phantom_pose_base[2]+0.01
		# target_waypoints.append(copy.deepcopy(phantom_pose_test))
		# phantom_pose_test[2] = phantom_pose_base[2]-0.01
		# target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		phantom_pose_test = copy.deepcopy(phantom_pose_base1)
		# phantom_pose_test[0] = phantom_pose_base[0]+0.03
		# phantom_pose_test[1] = phantom_pose_base[1]+0.00
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test[2] = phantom_pose_base[2]-0.005
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		phantom_pose_test = copy.deepcopy(phantom_pose_base2)
		# phantom_pose_test[0] = phantom_pose_base[0]-0.00
		# phantom_pose_test[1] = phantom_pose_base[1]-0.045
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test[2] = phantom_pose_base[2]-0.008
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		phantom_pose_test = copy.deepcopy(phantom_pose_base3)
		# phantom_pose_test[0] = phantom_pose_base[0]-0.015
		# phantom_pose_test[1] = phantom_pose_base[1]-0.00
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		# phantom_pose_test = copy.deepcopy(phantom_pose_base)
		# phantom_pose_test[0] = phantom_pose_base[0]-0.0
		# phantom_pose_test[1] = phantom_pose_base[1]+0.06
		# phantom_pose_test[2] = phantom_pose_base[2]+0.01
		# target_waypoints.append(copy.deepcopy(phantom_pose_test))
		# phantom_pose_test[2] = phantom_pose_base[2]-0.01
		# target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		phantom_pose_test = copy.deepcopy(phantom_pose_base)
		phantom_pose_test[2] = phantom_pose_test[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test = copy.deepcopy(phantom_pose_base)
		phantom_pose_test[2] = phantom_pose_test[2]-0.013
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test = copy.deepcopy(phantom_pose_base)
		phantom_pose_test[2] = phantom_pose_test[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		pneumatic.panda.set_line_velocity_scale(0.3)
		pneumatic.panda.go_to_muti_line_movement(target_waypoints,True)
		input("============ Press `Enter` to change the lip pressure ...")
		pneumatic.turn_on_main_pressure(255,160)
		while(pneumatic.main_pressure_< pneumatic.main_valve_trigger_pressure_):
			lip_pressure_ += lip_pressure_ratio
			if(lip_pressure_>=40):
				lip_pressure_ = 40
			print("pneumatic.main_pressure_!",pneumatic.main_pressure_)

			pneumatic.set_lip_limit_pressure(lip_pressure_)
			sleep(1)
		input("Done")

		input("============ Press `Enter` for end and back to the start point ...")
		pneumatic.turn_on_main_pressure(255,0)
		print("Turn off the lip pressure!")
		pneumatic.turn_off_lip()
		target_waypoints = []
		phantom_pose_test = copy.deepcopy(phantom_pose_base)
		phantom_pose_test[2] = phantom_pose_test[2]+0.03
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		pneumatic.panda.set_line_velocity_scale(0.2)
		pneumatic.panda.go_to_muti_line_movement(target_waypoints,True)
		print("Turn off the main pressure!")
		pneumatic.turn_off_main_pressure()
